                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <!-- Edit Modal -->
                                        <div class="modal fade" id="edit<?= $idm; ?>" tabindex="-1" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="" method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <button type="submit" class="btn btn-primary" name="updatebarangmasuk">Edit Barang</button>
                                                        </div>
                                                    </form>
                                        ...
                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="delete<?= $idm; ?>" tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
